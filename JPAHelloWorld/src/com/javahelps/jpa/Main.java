...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // Create two Students
       create(17, "Alice", 22); // Alice will get an id 1
        create(18, "Bob", 20); // Bob will get an id 2
        create(19, "Charlie", 25); // Charlie will get an id 3

        // Update the age of Bob using the id
        upate(14, "Gurpreet", 25);
    ...
    public static List<Student> readAll() {
        ...
        try {
            ...
            students =(List<Student>)manager.createQuery("FROM Student").getResultList();
